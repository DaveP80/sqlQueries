...
insert into
  brands (id, year, brand, amount)
values
  (10, 2019, 'Samsung', 16590);

insert into
  brands (id, year, brand, amount)
values
  (11, 2009, 'Samsung', 32443);

insert into
  brands (id, year, brand, amount)
values
  (12, 2007, 'Samsung', 41659);

insert into
  brands (id, year, brand, amount)
values
  (13, 2013, 'Samsung', 14914);

insert into
  brands (id, year, brand, amount)
values
  (14, 2022, 'Samsung', 41350);

insert into
  brands (id, year, brand, amount)
values
  (15, 1992, 'Samsung', 33497);
...
insert into
  brands_new(id, year, brand, amount)
select
  id,
  year,
  brand,
...
select
  *,
  (
    case
      when amount < lead(amount, 1, amount + 1) over(
        partition by brand
        order by
          year
      ) then 1
...
8 | 1993 | Nokia | 8849 9 | 2017 | Nokia | 43483