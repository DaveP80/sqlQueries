...
select distinct c.avail_start, c.avail_end from cte c join cte ce on c.rn != ce.rn where not ((c.avail_start, c.avail_end) overlaps (ce.avail_start, ce.avail_end));
